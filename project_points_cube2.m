function [xp,dxpdom,dxpdT,dxpdf,dxpdc,dxpdk,dxpdalpha] = project_points_cube2(X,om,T,f,c,k,alpha, cubeIdx,config)
...
if nargout > 1,
    [Y,dYdom,dYdT] = rigid_motion_cube(X,om,T, cubeIdx,config);
else
