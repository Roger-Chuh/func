...
try
    ...
    figure(101),hist(diffVecCam,50);title('camera extrinsic change distribution (mm)');
    figure(102),hist(diffVecIntr,50);title('camera intrinsic change distribution (pixel)');
catch
    sdfkgj = 1;
end
