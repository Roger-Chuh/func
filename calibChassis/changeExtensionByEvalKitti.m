...
function changeExtensionByEvalKitti(inputDir, varargin)
...
%           eval(['!rename' 32 strcat(dirInfo(i).name(end-4),'_',dirInfo(i).name(1:end-6),'.bin') 32 sprintf(strcat(nameStr, '_%04d.png'), i)]);
    elseif 0
