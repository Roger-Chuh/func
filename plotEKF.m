...
figure,subplot(2,2,1);plot(bg_head(:,2:4));title('bg_head');subplot(2,2,2);plot(ba_head(:,2:4));title('ba_head');
subplot(2,2,3);plot(bg_carrier(:,2:4));title('bg_carrier');subplot(2,2,4);plot(ba_carrier(:,2:4));title('ba_carrier');
...
figure;hold on;plot(a(:,1),[a(:,2)],'-r');plot(a(:,1),[a(:,3)],'-r');plot(a(:,1),[a(:,4)],'-r');
               plot(b(:,1),[b(:,2)],'-b');plot(b(:,1),[b(:,3)],'-b');plot(b(:,1),[b(:,4)],'-b');
               plot(c(:,1),[c(:,2)],'-g');plot(c(:,1),[c(:,3)],'-g');plot(c(:,1),[c(:,4)],'-g');
legend('predict','predict','predict','hf','hf','hf','ekf','ekf','ekf');
...
figure,subplot(2,1,1);plot([vel_before(1:len,2:4)],'-r','LineWidth', 3);hold on;plot(vel_after(1:len,2:4),'-b');subplot(2,1,2);plot([vel_before(1:len,2:4) - vel_after(1:len,2:4)]);title('vel');
...
figure,subplot(2,1,1);plot([acc_head_before(1:len,2:4)],'-r','LineWidth', 3);hold on;
...
figure,subplot(2,1,1);plot([acc_carrier_before(1:len,2:4)],'-r','LineWidth', 3);hold on;plot(acc_carrier_after(1:len,2:4),'-b');subplot(2,1,2);plot([acc_carrier_before(1:len,2:4) - acc_carrier_after(1:len,2:4)]);title('acc carrier');
...
figure,subplot(2,1,1);plot([gyro_head_before(1:len,2:4)],'-r','LineWidth', 3);hold on;plot(gyro_head_after(1:len,2:4),'-b');subplot(2,1,2);plot([gyro_head_before(1:len,2:4) - gyro_head_after(1:len,2:4)]);title('gyro head');
...
figure,subplot(2,1,1);plot([gyro_carrier_before(1:len,2:4)],'-r','LineWidth', 3);hold on;plot(gyro_carrier_after(1:len,2:4),'-b');subplot(2,1,2);plot([gyro_carrier_before(1:len,2:4) - gyro_carrier_after(1:len,2:4)]);title('gyro carrier');
