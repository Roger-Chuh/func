...
% fprintf('============================================================\n');
% align1d_zncc(eye(2), host_image_scaled1, target_image_scaled1, px_host_scaled1, px_target_scaled1, host_offset1, target_offset1, epiDir, epiDir, 2*(halfpatch_size+1));
fprintf('============================================================\n');
...
fprintf('============================================================\n');
align1d_zncc2(A_th, search_level, host_image_scaled2, target_image_scaled2, px_host_scaled2, px_target_scaled2, host_offset2, target_offset2, epiDir, epiDir, 2*(halfpatch_size+1));


end
function align1d_zncc(A_th, host_image, target_image,  px_host_scaled, px_target_scaled, host_offset, target_offset, epiDir, epiDir_noise, patch_size)
...
px_target_scaled_error = px_target_scaled + 3.*epiDir_noise;
...
function align1d_zncc2(A_th_, search_level, host_image, target_image,  px_host_scaled, px_target_scaled, host_offset, target_offset, epiDir, epiDir_noise, patch_size)
use_b_only = false;
...
JznccMat = J_zncc * [gxxx gyyy] * (A_th) * epiDir';

Hess = JznccMat' * JznccMat;
Hess_inv = 1 / Hess;


px_target_scaled_error = px_target_scaled + 2.*epiDir_noise;
...
D0 = det(A_cur_ref);
D = det(A_cur_ref);
while(D > 2 && search_level < max_level)
