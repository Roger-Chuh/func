function testUndistortion2()

close all
J = checkerboard(40,7,7);
J = J > 0.5;
J = uint8(255.*J);
J = imresize(J,[1600 1600]);
if 0
...
intrMat_gt = [800 0 800; 0 800 800;0 0 1];
% intrMat_gt = [400 0 (width_gt+1)/2+0; 0 450 (height_gt+1)/2-0;0 0 1];
intrMat_virtual = [510 0 (width_virtual+1)/2; 0 520 (height_virtual+1)/2;0 0 1];
intrMat_virtual = [intrMat_gt(1,1)*1.0*scale(1) 0 800; 0 intrMat_gt(2,2)*1*scale(2) 800;0 0 1];
% k = -[0.3 0.2 0.00001 -0.00003 0.003]';
k = [0.279 0.049 0 0 0.146]';
